...
export class LoadPage implements OnInit {
  ...
  ngOnInit() {
    ...
    if(!sessionStorage.getItem("destroyed")){
      setTimeout(() => { this.router.navigate(['/tabs']) }, 5000);
    }
    else if(sessionStorage.getItem("destroyed")){
  ...
  gif: string = String(randomIntFromInterval(0, 39));
  phrase: string = String(this.quotes[randomIntFromInterval(1, 266)]);
